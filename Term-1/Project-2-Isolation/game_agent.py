...
def custom_score(game, player):
    ...
    # weight opponent moves and moves more than one space more
    ...
    for move in my_moves:
        if move[0] - my_location[0] > 1 or move[1] - my_location[1] > 1:
            value += 2
        else:
            value += 1
    ...
    for move in opp_moves:
        if move[0] - opp_location[0] > 1 or move[1] - opp_location[1] > 1:
            value -= 3
        else:
            value -= 2
...
def custom_score_2(game, player):
    ...
    # weight moves more highly if they are more than one space away from current position
    my_moves = game.get_legal_moves(player)
    my_location = game.get_player_location(player)
    opp_moves = game.get_legal_moves(game.get_opponent(player))
    opp_location = game.get_player_location(game.get_opponent(player))
...
def custom_score_3(game, player):
    ...
    # weight opponent moves more highly to encourage moves that cut off opponent
