...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        return bool(a1_add & a2_rem) or bool(a1_rem & a2_add)
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        a1_pos = set(node_a1.action.precond_pos)
        a1_neg = set(node_a1.action.precond_neg)
        a2_pos = set(node_a2.action.precond_pos)
        a2_neg = set(node_a2.action.precond_neg)

        return bool(a1_add & a2_neg) or bool(a1_rem & a2_pos) or bool(a2_add & a1_neg) or bool(a2_rem & a1_pos)
